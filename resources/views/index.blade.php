...
<body>
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 mb-30">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
                ...
                <div class="lg:py-24">
                    ...
                    <a href="#"
                        class="mt-8 inline-block rounded bg-black px-12 py-3 text-sm font-medium text-white transition hover:bg-gray-200 focus:outline-none focus:ring focus:ring-yellow-400">
                        Show More
                    </a>
                </div>
            </div>
    ...
    <!-- Container Utama -->
    <div class="w-full flex justify-between items-start px-[100px] py-[60px] mb-[60px]">
        <!-- Bagian Kiri -->
        <div class="max-w-[300px]">
            <h1 class="text-[#000000] text-[30px] font-bold leading-[48px] font-poppins mt-24">
                Update Profile User
            </h1>
            <p class="text-[#000000] text-[16px] font-roboto leading-[24px]">
        ...
        <div class="w-full max-w-[500px]">
            <form class="flex flex-col gap-[24px]">
                <!-- Full Name -->
                <div>
                    <label for="full-name" class="block text-[14px] font-roboto font-medium text-[#000000]">
                        Full Name
                    </label>
                    <input id="full-name" type="text" placeholder="Enter your full name"
                        class="w-full p-[12px] border border-[#e0e0e0] rounded-[6px] focus:outline-none focus:ring-2 focus:ring-[#000000]" />
                </div>
                <!-- Email -->
                <div>
                    <label for="email" class="block text-[14px] font-roboto font-medium text-[#000000]">
                        Email
                    </label>
                ...
                <!-- Gender -->
                <div>
                    <p class="text-[14px] font-roboto font-medium text-[#000000]">Gender</p>
                    <div class="flex gap-[16px]">
                        <label class="flex items-center gap-[4px]">
                            <input type="radio" name="gender" value="male" class="mr-[4px]" />
                            <span class="text-[#000000] text-[14px]">Male</span>
                        </label>
                        <label class="flex items-center gap-[4px]">
                            <input type="radio" name="gender" value="female" class="mr-[4px]" />
                            <span class="text-[#000000] text-[14px]">Female</span>
                        </label>
                        <label class="flex items-center gap-[4px]">
                            <input type="radio" name="gender" value="other" class="mr-[4px]" />
                            <span class="text-[#000000] text-[14px]">Other</span>
                        </label>
                    </div>
                </div>
                <!-- Save Button -->
                <div class="w-full">
                    <button type="submit"
                        class="w-full p-[12px] bg-[#000000] text-[#ffffff] rounded-[8px] text-[16px] font-roboto font-medium hover:bg-[#333333]">
                        Save Changes
                    </button>
                </div>
            </form>
    ...
    <div class="w-full h-auto px-24 py-16 mb-10">
        ...
        <div class="grid grid-cols-2 gap-10 mt-16">
            ...
            <div class="flex flex-col justify-center mb-10">
                ...
                <a href="#" class="text-[#3B82F6] font-medium text-lg hover:underline flex items-center gap-2">
                    Learn more
    ...
    <!-- Features Section -->
    <div class="max-w-6xl mx-auto p-4 mb-64">
        <h1 class="text-2xl font-bold sm:text-3xl text-center mb-4">Best Features</h1>
        <p class="text-center mb-20">Check out our featured features</p>
    ...
    <!-- Banner -->
    <section
        class="relative bg-[url(https://images.unsplash.com/photo-1557804506-669a67965ba0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGNhcmVlcnxlbnwwfHwwfHx8MA%3D%3D)] bg-cover bg-center bg-no-repeat mb-20"
        style="height: 250px;"> <!-- Mengubah tinggi dari 292px menjadi 250px -->
        <div
        ...
        <div class="relative mx-auto max-w-screen-xl px-6 py-8 sm:px-10 lg:flex lg:h-screen lg:items-center lg:px-8">
            <!-- Mengubah padding kiri dan kanan -->
        </div>
    </section>
