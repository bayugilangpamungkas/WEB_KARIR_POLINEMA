        ...
        <div class="lg:grid lg:min-h-screen lg:grid-cols-12 ">
            ...
            <main
                ...
                <div class="max-w-xl lg:max-w-3xl">
                    ...
                    <h1 class="mt-6 mb-14 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl">
                    ...
                    <form action="#" class="mt-8 grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
                            <button
                                class="inline-block shrink-0 rounded-md border border-violet-600 bg-violet-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-violet-600 focus:outline-none focus:ring active:text-violet-500">
                                Create an account
                            </button>
